...
# Generated: Wed Jul  8 12:04:41 2020
##################################################
...
class Radar_Data_Client(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, parameter_0=149):
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_complex_to_interleaved_short_0, 0), (self.qtgui_number_sink_0, 0))
        ...
        self.connect((self.blocks_vector_to_stream_0_0, 0), (self.blocks_float_to_complex_0, 0))
        self.connect((self.blocks_vector_to_stream_0_0, 0), (self.blocks_float_to_complex_0, 1))
