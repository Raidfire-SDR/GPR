...
# Title: Simulator Fsk
# Generated: Wed Jul  8 09:52:38 2020
##################################################
...
class simulator_fsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.top_grid_layout.addWidget(self._protect_win)
        ...
        self.top_grid_layout.addWidget(self._range_value_win)
        ...
        self.pluto_source_0 = iio.pluto_source('ip:pluto.local', lo, samp_rate, q, 0x8000, False, False, True, "manual", gain, '', True)
        self.pluto_sink_0 = iio.pluto_sink('ip:pluto.local', lo, samp_rate, q, 0x8000, False, 0, '', True)
        ...
        self.top_grid_layout.addWidget(self._delaytime_win)
        ...
        self.connect((self.radar_signal_generator_fsk_c_0, 0), (self.qtgui_waterfall_sink_x_0, 0))
